...
function BuddyFindMap({ addMarkerWithInfo, addrss, setAddrss, memAddresses, setMemAddresses, items, setItems, coordinates, setCoordinates, coordinatesTwo, setCoordinatesTwo, member, setMember }) {
