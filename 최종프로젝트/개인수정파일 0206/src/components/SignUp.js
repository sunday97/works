...
function SignUp() {
  ...
  useEffect(() => {
    // 닉네임은 영문 또는 숫자이어야 하며, 4자 이상이어야 합니다.
  ...
  const Validation = () => {
    if (!isEmail) {
      ...
      alert("닉네임은 영문 또는 숫자이어야 하며, 4자 이상이어야 합니다.");
      return false;
    } else if (!myaddress) {
      alert("우편 찾기를 해주세요.");
      return false;
        ...
        <div className={styles.container}>
          <div className={styles.kakaoWrap}>
            ...
            <div className={styles.kakaoLogin}>
              <GoogleLoginButton onGoogleEmail={handleGoogleEmail} />
            </div>
          </div>
            ...
            <div>
              <form>
                ...
                <div>
                  ...
                  <div>
                    <input
                      placeholder="닉네임은 영문 또는 숫자이어야 하며, 4자 이상이어야 합니다."
                      type="text"
                      id="nickname"
                      name="nickname"
                      required
              ...
              <SelectBtn onClick={onClick}>가입 완료</SelectBtn>
            </div>
          ) : (
            ""
          )}
