...
function NoticeBoard({
  ...
  const writeReviewClick = async (reviewId) => {
    try {
      if (reviewId === undefined) {
        ...
        await updateData("Member", accountDocId, {
  ...
  const deleteBoardList = async () => {
    const deleteCheck = await deleteDatas("Board", content?.docId);
  ...
  const handleReplyEdit = async (text, reviewId, replyId) => {
    if (text == "수정") {
      ...
      const replyCancel = await deleteReply(
        "Board",
        content?.docId,
        reviewId,
        replyId
              ...
              <div className={styles.contents}>
                ...
                >
                  ...
                  <div className={styles.contentTitle}>
                    ...
                    {accountName == reviewItem?.REVIEW_USERNAME && (
                        ...
                        {reviewItem?.REVIEW_REPLY?.map((reply) => (
                          ...
                          >
                            <div className={styles.replyWrap}>
                              ...
                              {accountName == reply?.REPLY_USERNAME && (
                                // 대댓글 수정 삭제
