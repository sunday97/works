...
제이슨홀더-DB활용연습할 때 사용하는 db? 로 좋음(Free fake API site)
...
#### refiapp (서버에 데이터를 편안하게 추가할 수 있는 app?)

> https://refiapp.io/ -> 다운로드.exe

### 리액트는 훅만 잘 쓰면 나머진 자바스크립트다!
...
1. 핀터레스트[https://www.pinterest.co.kr]에서 포트폴리오(포트폴리오 피그마) 검색하거나,
2. 비헨스[https://www.behance.net/]에서 포폴검색 ㄱㄱ(단 여긴 영어사이트니 영어로 검색해야함)
